...
const FirstPart = () => {
  return (
    <section
      id="home"
      className="flex flex-col lg:flex-row items-center justify-between min-h-screen bg-linear-to-r from-[#d9f3f1] via-[#f5e6f5] to-[#fce9d2] px-4 sm:px-8 lg:px-16 gap-8"
    >
      {/* TEXT SIDE */}
